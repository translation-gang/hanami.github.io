...
Он будет привязан непосредственно к контексту действия.
...
Hanami использует их для обеспечения более оптимального **управления порядком действий** в действиях при помощи `#halt`.

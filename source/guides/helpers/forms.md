---
title: Руководство - Хэлперы форм
---

## Хэлперы формы

В Ханами встроен мощный API для описания HTML5 форм при помощи Ruby. Он используется в представлениях и шаблонах. В его состав входят:
...
Чтобы заставить его работать, эти фреймоврки используют собственные ERB обработчики или используют сторонние гемы в случае других шаблонизаторов.
...
Наш API очень чист и выразителен. **Он не требует конкатинировать** возвращаемые значения блоков(`submit`) и предшествующих строк в шаблоне(`div`).
